...
module.exports = function (grunt) {
	...
	var all_files = ['**/*.html', '**/*-combo.js', '**/*.css', 'test/**/*', '!mock/**/*', '!**/node_modules/**/*', '!**/build/**/*', '**/*.png', '**/*.jpg'];
    ...
    grunt.initConfig({
        ...
        watch: {
            'all': {
                ...
                files: ['src/**/*.js', 'src/**/*.less', '!src/mod.js', '!src/**/*-all.js'],
                tasks: [ 'build' ]
            }
		},
		...
		browserify: {
			main: {
				files: [
					//'src/tobacco-qy.js': ['src/all.js']
						{
								expand: true,
								cwd: 'src/',
								src: ['pages/**/*.js', '!pages/**/*-combo.js'],
								dest: 'src/',
								ext: '-combo.js'
						}
				]
	...
	grunt.registerTask('build', '默认构建任务', function() {
		task.run(['clean:build', 'less', 'browserify', 'copy', 'combohtml', /*'replace', */'uglify', 'cssmin']);
	});
